...
let rachele = {
  ...
  code: {
    'frontend': ['HTML', 'CSS', 'LESS', 'JavaScript', 'ReactJS', 'Boostrap/Reactstrap', 'Style-Components', 'emotion-js', 'AntDesign', 'Material UI'],
    'backend': ['NodeJS', 'Express', 'Jest'],
    'database': ['SQLite3', 'PostGresSQL'],
    'devops': ['GitHub Pages', 'Vercel (Zeit)', 'Heroku', 'AWS', 'Firebase'],
